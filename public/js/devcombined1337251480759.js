...
(function() {
  var debugWin, debugWinVis, editWidget, editor, editorbrowser, editorcss, editorhtml, editornodejs, initeditortabs, initialized, loadwidgets, makeEditable, nowediting, publish, thing, writelog;
    ...
    return $('#debugloghandle').click(function() {
      if (!debugWinVis) {
        ...
        $('#debugloghandle').animate({
          ...
          return $('#debugloghandle').css('right', '0px');
        });
        $('#debuglog').animate({
          width: '-450'
        }, 70);
