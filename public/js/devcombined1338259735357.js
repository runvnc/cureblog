...
(function() {
  ...
  window.origlog = window.console.log;
  ...
  IPWTextTool = (function() {
    ...
    function IPWTextTool() {
      ...
      $('#page, .pagescontent').bind('click', function(ev) {
        ...
        console.log($(ev.target));
        console.log($(ev.target).hasClass('.pagescontent'));
        ispage = ev.target.className.indexOf('pagescontent') >= 0;
        console.log('ev.target.classname is ' + ev.target.className);
        ...
        if (_this.active) {
          console.log('ok2');
          return text = new IPWTextWidget($(ev.target), x, y);
        }
      });
