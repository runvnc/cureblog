...
(function() {
  ...
  $(function() {
    ...
    return $('.groove').click(function() {
      window.open('http://somafm.com/support/', '_blank');
      return window.gsurl = "http://somafm.com/popup/?groovesalad";
    });
  });

  newwindow = window.open("http://somafm.com/popup/?groovesalad", 'SomaPlayer', 'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=410,height=220,left = 200,top = 140');
