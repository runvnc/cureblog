...
(function() {
  var cwd, getlink, listFiles, shiftSel, showFiles, sortem;
  ...
  shiftSel = function(e) {
    var clickedIndex, i, selIndex, _results;
    selIndex = $('.fmselected').index();
    clickedIndex = $(this).index();
    $('.fmselected').removeClass('fmselected');
    _results = [];
    for (i = selIndex; selIndex <= clickedIndex ? i <= clickedIndex : i >= clickedIndex; selIndex <= clickedIndex ? i++ : i--) {
  ...
  showFiles = function(files) {
    ...
    return $('.fmitem').click(function(e) {
      if (e.ctrlKey) {
