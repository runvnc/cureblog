...
(function() {
  var debugWin, debugWinVis, editWidget, editor, editorbrowser, editorcss, editorhtml, editornodejs, initeditortabs, initialized, loadwidgets, loghandle, logmsgcnt, makeEditable, nowediting, origlog, publish, thing, writelog;
  ...
  $(function() {
    return $(document).bind('sessionState', function(user) {
      if (window.loggedIn) {
        ...
        console.log('in image user is (' + user + ')');
