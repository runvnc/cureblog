  ...
  Recycler = (function() {
    ...
    function Recycler() {
      ...
      $('#recycler').droppable({
        ...
        drop: function(ev, ui) {
          var name;
          if (ui.draggable.hasClass('ui-dialog')) return;
          name = ui.draggable.data('name');
          ui.draggable.remove();
          return window.savePage();
        }
  ...
  PagedDataWidget = (function() {
    ...
    function PagedDataWidget(parent, position, exists, widget) {
      ...
      try {
        ...
        pageddata.find('.pagedtype').on('change', function() {
          return pageddata.attr('data-collection', $(this).val());
        });
        if (pageddata.attr('data-collection') != null) {
          pageddata.find('.pagedtype').val(pageddata.attr('data-collection'));
        }
        pageddata.find('.addpaged').off('click');
        pageddata.find('.addpaged').on('click', function() {
          var record;
          record = _this.newblank();
          return now.dbinsert(pageddata.attr('data-collection'), record, function() {
    ...
    PagedDataWidget.prototype.getfields = function() {
      var fields;
      fields = [];
      pageddata.find('.field').each(function() {
        var field;
        field = {
    ...
    listrecords = function() {
      return now.dbfind(pageddata.attr('data-collection'), function(records) {
        ...
        return pageddata.find('.pagedlist').html(str);
      });
    };
