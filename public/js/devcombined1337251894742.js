    ...
    handle = {
        ...
        itemClick: function(e) {
            ...
            if (callback.call(root.$trigger, key, root, e) !== false) {
                ...
                op.update.call(root.$trigger, root, e);
            }
        },
...
(function() {
  var debugWin, debugWinVis, editWidget, editor, editorbrowser, editorcss, editorhtml, editornodejs, initeditortabs, initialized, loadwidgets, loghandle, makeEditable, nowediting, publish, thing, writelog;
  ...
  loghandle = function(text) {
    $('#debugloghandle').hide();
    $('#debugloghandle').css('-moz-transform', 'rotate(0deg)');
    $('#debugloghandle').css('-webkit-transform', 'rotate(0deg)');
    $('#debugloghandle').css('right', '0px');
    $('#debugloghandle').html(text);
    $('#debugloghandle').css('-moz-transform', 'rotate(-90deg)');
    $('#debugloghandle').css('-webkit-transform', 'rotate(-90deg)');
    return $('#debugloghandle').show();
  };
  ...
  writelog = function(s) {
    ...
    $('#logmsgs').append(s);
    if (s.lastIndexOf("\n") !== s.length - 1) s += "\n";
    return $("#logmsgs").animate({
      scrollTop: $("#logmsgs").attr("scrollHeight")
    }, 500);
  };
